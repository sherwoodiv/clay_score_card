  ...
  <UApp>
    <NuxtPage>
      <UContainer>
        ...
        <UModal v-model:open="showResumeModal" :dismissible="false" title="Resume Session">
          <template #body>
            <h3 class="text-2xl">Resume Previous Session?</h3>
            <p>
              A previous scoring session was found. Do you want to resume or start fresh?
            </p>
            <div class="flex gap-3 justify-end">
              <UButton @click="startNew" color="warning">Start New</UButton>
        ...
        <UCard>
          <!-- Main App -->
          <div class="container">
            <h1 class="text-3xl pb-4">Clay Shooting Score Tracker</h1>
            <div class="settings" v-if="rounds>-1">
              <div class="add-shooter flex flex-box">
                <UInput v-model="newShooterName" placeholder="Enter shooter name" class="flex-2/3"/>
                <UButton @click="addShooter" :disabled="shooters.length >= 8 || !newShooterName.trim()">
                  Add Shooter
                </UButton>
              </div>
              <UButton v-if="rounds.length === 0" @click="autoSetup" class="auto-setup">
            ...
            <div v-else>
              ...
              <div class="round-tabs">
                <UButton @click="currentView = -1" :class="{ active: currentView === -1 }">Summary</UButton>
                <UButton
                ...
                <UButton v-if="remaining > 0" @click="showAddRound = !showAddRound">+</UButton>
              </div>
              ...
              <div v-if="currentView === -1" class="summary-view">
                <!-- Top Shooter Badge -->
                <div v-if="shooters.length > 1" class="mt-8 text-center">
                  ...
                  >
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-800 dark:to-blue-900 text-white p-4">
                      <div class="flex justify-between items-center">
                        <h3 class="text-xl font-bold">{{ shooter.name }}</h3>
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-900">
                      <div class="grid grid-cols-4 sm:grid-cols-6 gap-3">
                        <div
                          ...
                          class="text-center"
                        >
                          <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">R{{ i + 1 }}</div>
                          <div
